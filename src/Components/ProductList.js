          ...
          <div className="col-md-3 col-sm-6">
           <div className="product-grid">
             <div className="product-image">
              ...
              <span className="product-discount-label">-{ob.discount}</span>
              </div>
             <div className="product-content">
               <h3 className="title" ><a href="#">{ob.title}</a></h3>
               <div className="price"><span>${ob.price}.00</span>${parseInt(ob.price*((100-ob.discount)/100))}.00</div>
